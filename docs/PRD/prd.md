...
- **系統管理員**: 負責系統配置、合約定義、規則設定、任務管理和系統監控的主要用戶
- **協作者（Collaborator）**: 專案層級的參與者，可執行特定任務和查看相關資訊
- **夥伴（Partner）**: 具有協作權限的角色，可參與特定領域的工作

### 3.3 基於角色的訪問

- **系統管理員**: 完全訪問權限，包括系統配置、事件發布訂閱、合約管理、任務調度、審計日誌查詢、規則配置和系統監控
- **協作者**: 受限訪問權限，可執行指派的任務、查看相關事件和合約資訊
- **夥伴**: 特定領域的協作權限，可參與指定範圍的工作和決策
